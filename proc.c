...
//sapir 15.3
// enum policy { RoundRobin, PRIORITY, EXPRIORITY };
// enum policy pol = RoundRobin;
...
void Priority_Scheduler(struct cpu* c)
{
  ...
  //when process is finish we add his priority to the 
  release(&ptable.lock);
}
//PAGEBREAK: 42
