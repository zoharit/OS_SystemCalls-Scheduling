   ...
   1:	b9 02 00 00 00       	mov    $0x2,%ecx
{
  ...
  14:	c7 04 24 28 08 00 00 	movl   $0x828,(%esp)
  ...
  50:	ba 30 08 00 00       	mov    $0x830,%edx
  ...
  95:	74 b9                	je     50 <main+0x50>
      printf(1, "zombie!\n");
  97:	b8 6f 08 00 00       	mov    $0x86f,%eax
  ...
  ac:	eb d2                	jmp    80 <main+0x80>
      printf(1, "init: fork failed\n");
  ae:	c7 44 24 04 43 08 00 	movl   $0x843,0x4(%esp)
  b5:	00 
  ...
  c9:	e8 9a 02 00 00       	call   368 <exit>
      exec("sh", argv);
  ce:	c7 44 24 04 10 0b 00 	movl   $0xb10,0x4(%esp)
  d5:	00 
  d6:	c7 04 24 56 08 00 00 	movl   $0x856,(%esp)
  dd:	e8 be 02 00 00       	call   3a0 <exec>
      printf(1, "init: exec sh failed\n");
  e2:	c7 44 24 04 59 08 00 	movl   $0x859,0x4(%esp)
  e9:	00 
 ...
 111:	00 
 112:	c7 04 24 28 08 00 00 	movl   $0x828,(%esp)
 119:	e8 92 02 00 00       	call   3b0 <mknod>
    open("console", O_RDWR);
 11e:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
 125:	00 
 126:	c7 04 24 28 08 00 00 	movl   $0x828,(%esp)
 ...
 6a1:	a1 18 0b 00 00       	mov    0xb18,%eax
{
 ...
 6e7:	5b                   	pop    %ebx
  freep = p;
 6e8:	a3 18 0b 00 00       	mov    %eax,0xb18
}
 6ed:	5e                   	pop    %esi
 6ee:	5f                   	pop    %edi
 6ef:	5d                   	pop    %ebp
 ...
 6fe:	72 ce                	jb     6ce <free+0x2e>
{
 ...
 721:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 724:	a3 18 0b 00 00       	mov    %eax,0xb18
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 18 0b 00 00    	mov    0xb18,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 3f                	jae    7d0 <malloc+0x90>
    ...
    if(p == freep)
 791:	39 05 18 0b 00 00    	cmp    %eax,0xb18
 ...
 7b1:	e8 ea fe ff ff       	call   6a0 <free>
  return freep;
 7b6:	8b 15 18 0b 00 00    	mov    0xb18,%edx
 ...
 7dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7df:	89 15 18 0b 00 00    	mov    %edx,0xb18
}
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	b8 1c 0b 00 00       	mov    $0xb1c,%eax
 7f5:	ba 1c 0b 00 00       	mov    $0xb1c,%edx
    base.s.size = 0;
 7fa:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 7fc:	a3 18 0b 00 00       	mov    %eax,0xb18
    base.s.size = 0;
 801:	b8 1c 0b 00 00       	mov    $0xb1c,%eax
    base.s.ptr = freep = prevp = &base;
 806:	89 15 1c 0b 00 00    	mov    %edx,0xb1c
    base.s.size = 0;
 80c:	89 0d 20 0b 00 00    	mov    %ecx,0xb20
