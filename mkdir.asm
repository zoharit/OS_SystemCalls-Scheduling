...
main(int argc, char *argv[])
{
  ...
  44:	c7 44 24 04 7f 07 00 	movl   $0x77f,0x4(%esp)
  4b:	00 
 ...
 35e:	84 db                	test   %bl,%bl
{
 ...
 389:	0f b6 92 a4 07 00 00 	movzbl 0x7a4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c8:	e9 7e fe ff ff       	jmp    44b <printf+0x5b>
          s = "(null)";
 5cd:	bb 9b 07 00 00       	mov    $0x79b,%ebx
        while(*s != 0){
 ...
 5e1:	a1 34 0a 00 00       	mov    0xa34,%eax
{
 ...
 627:	5b                   	pop    %ebx
  freep = p;
 628:	a3 34 0a 00 00       	mov    %eax,0xa34
}
 62d:	5e                   	pop    %esi
 62e:	5f                   	pop    %edi
 62f:	5d                   	pop    %ebp
 ...
 63e:	72 ce                	jb     60e <free+0x2e>
{
 ...
 661:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 664:	a3 34 0a 00 00       	mov    %eax,0xa34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f1:	e8 ea fe ff ff       	call   5e0 <free>
  return freep;
 6f6:	8b 15 34 0a 00 00    	mov    0xa34,%edx
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 71f:	89 15 34 0a 00 00    	mov    %edx,0xa34
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	b8 38 0a 00 00       	mov    $0xa38,%eax
 735:	ba 38 0a 00 00       	mov    $0xa38,%edx
    base.s.size = 0;
 73a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 73c:	a3 34 0a 00 00       	mov    %eax,0xa34
    base.s.size = 0;
 741:	b8 38 0a 00 00       	mov    $0xa38,%eax
    base.s.ptr = freep = prevp = &base;
 746:	89 15 38 0a 00 00    	mov    %edx,0xa38
    base.s.size = 0;
 74c:	89 0d 3c 0a 00 00    	mov    %ecx,0xa3c
